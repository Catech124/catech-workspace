...
export const appTransferMode: ToolcraftTransferMode = {
  animationIntent: { mode: "timeline-playback", loopDuration: { evidence: "Core shell default loop duration for playback preview", seconds: 12, source: "user-request" } },
  mode: "new-toolcraft-app",
};

export const appProductReadiness: ToolcraftProductReadiness = {
  mode: "product",
  productName: "ARC Core Shell",
  productSummary:
    "Core editor shell with canvas, timeline playback, export controls, media pool, FPS/resolution/quality settings, and on-demand recipe system for node-based compositing.",
  requestedBehavior:
    "A modular video editor shell built on Toolcraft that exposes always-present core features (timeline, export, media pool, render settings) while loading node graphs, inspectors, spline editors, and modifiers on demand via recipes.",
};
