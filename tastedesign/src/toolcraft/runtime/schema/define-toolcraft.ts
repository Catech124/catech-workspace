...
function createSettingsTransferSection(): ToolcraftControlSectionSchema {
  return {
    controls: {
      settingsTransfer: {
        label: false,
...
function normalizePanels({
  ...
  const settingsTransferSection = createSettingsTransferSection();
...
export function defineToolcraft(schema: ToolcraftAppSchema): ResolvedToolcraftAppSchema {
  ...
  const resolvedSettingsTransfer = resolveSettingsTransfer({
  ...
  return {
    ...
    panels,
    persistence,
    settingsTransfer: resolvedSettingsTransfer,
    toolbar,
  };
}
