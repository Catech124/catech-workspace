...
- `references/arc-video-editor.md` — ARC Video Editor: keyframe timeline, modifiers (oscillate/shake), morph text, iframe preview architecture, UI design preferences.
